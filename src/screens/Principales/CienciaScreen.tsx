...
import { useCiencia, useCienciaUna } from '../../hooks/useCiencia';
...
export const CienciaScreen = ({ navigation,route }:any) => {    
  /*  const navigator = useNavigation();*/  
    const {articles,handleClick}=useCiencia();        
    const {datosCiencia}=useCienciaUna();
    ...
    return (
        <View style={{backgroundColor:COLORS.lightGray2}}>
            ...
            <TopNoticia datos={datosCiencia}  navigation={navigation}/> 
