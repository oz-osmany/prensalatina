...
import { useCultura, useCulturaUna } from '../../hooks/useCultura';
...
export const CulturaScreen = ({ navigation,route }: any) => {    
  /*  const navigator = useNavigation();*/  
    const {articles,handleClick}=useCultura();        
    const {datosCultura}=useCulturaUna();
    ...
    return (
        ...
        <TopNoticia datos={datosCultura}  navigation={navigation}/> 
