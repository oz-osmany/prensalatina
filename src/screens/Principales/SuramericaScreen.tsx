...
import { useSurAmerica, useSuramericaUna } from '../../hooks/useSurAmerica';
...
export const SuramericaScreen = ({ navigation,route }: any) => {    
  /*  const navigator = useNavigation();*/  
    const {datosSuramerica}=useSuramericaUna();        
    const {articles,handleClick}=useSurAmerica();
    ...
    return (
        ...
        <TopNoticia datos={datosSuramerica}  navigation={navigation}/> 
