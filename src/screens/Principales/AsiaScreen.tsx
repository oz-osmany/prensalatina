...
import { useAsia, useAsiaUna } from '../../hooks/useAsia';
...
export const AsiaScreen = ({ navigation,route }: Props) => {    
    // const navigation = useNavigation(); 
    const {articles,handleClick}=useAsia();
    const {datosAsia}=useAsiaUna();        
    ...
    return (
        ...
        <TopNoticia datos={datosAsia}  navigation={navigation}/> 
